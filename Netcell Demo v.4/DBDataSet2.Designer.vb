...
Partial Public Class DBDataSet2
    ...
    Partial Public Class cedulasDataTable
        ...
        Public Overloads Function AddcedulasRow( _
                    ...
                    ByVal huellaSensor() As Byte) As cedulasRow
            Dim rowcedulasRow As cedulasRow = CType(Me.NewRow,cedulasRow)
            Dim columnValuesArray() As Object = New Object() {id, cedula, nombres, apellidos, nacionalidad, sexo, lugar_nacimiento, fecha_nacimiento, profesion, telefono, direccion, fecha_expiracion, numero_plastico, numero_chip, foto, firma, huella, huellaSensor}
    ...
    Partial Public Class cedulasTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [main].[sqlite_default_schema].[cedulas] ([id], [cedula], [nombres], "& _ 
                ...
                "o_chip], [foto], [firma], [huella], [huellaSensor]) VALUES (@id, @cedula, @nombr"& _ 
                "es, @apellidos, @nacionalidad, @sexo, @lugar_nacimiento, @fecha_nacimiento, @pro"& _ 
                "fesion, @telefono, @direccion, @fecha_expiracion, @numero_plastico, @numero_chip"& _ 
                ", @foto, @firma, @huella, @huellaSensor)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT [id], [cedula], [nombres], [apellidos], [nacionalidad], [sexo], [lugar_nac"& _ 
                ...
                "acion], [numero_plastico], [numero_chip], [foto], [firma], [huella], [huellaSens"& _ 
                "or] FROM [cedulas]"
        ...
        Public Overloads Overridable Function Insert( _
                    ...
                    ByVal firma() As Byte,  _
                    ByVal huella() As Byte,  _
                    ByVal huellaSensor() As Byte) As Integer
        ...
        Public Overloads Overridable Function Update( _
                    ...
                    ByVal Original_huella() As Byte,  _
                    ByVal Original_huellaSensor() As Byte) As Integer
            Return Me.Update(Original_id, cedula, nombres, apellidos, nacionalidad, sexo, lugar_nacimiento, fecha_nacimiento, profesion, telefono, direccion, fecha_expiracion, numero_plastico, numero_chip, foto, firma, huella, huellaSensor, Original_id, Original_cedula, Original_nombres, Original_apellidos, Original_nacionalidad, Original_sexo, Original_lugar_nacimiento, Original_fecha_nacimiento, Original_profesion, Original_telefono, Original_direccion, Original_fecha_expiracion, Original_numero_plastico, Original_numero_chip, Original_foto, Original_firma, Original_huella, Original_huellaSensor)
        End Function
    End Class
