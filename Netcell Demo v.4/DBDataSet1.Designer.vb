...
Partial Public Class DBDataSet1
    ...
    Partial Public Class cedulasDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddcedulasRow(ByVal id As Long, ByVal cedula As String, ByVal nombres As String, ByVal apellidos As String, ByVal nacionalidad As String, ByVal sexo As String, ByVal lugar_nacimiento As String, ByVal fecha_nacimiento As String, ByVal profesion As String, ByVal telefono As String, ByVal direccion As String, ByVal fecha_expiracion As String, ByVal numero_plastico As String, ByVal numero_chip As String) As cedulasRow
            Dim rowcedulasRow As cedulasRow = CType(Me.NewRow,cedulasRow)
            Dim columnValuesArray() As Object = New Object() {id, cedula, nombres, apellidos, nacionalidad, sexo, lugar_nacimiento, fecha_nacimiento, profesion, telefono, direccion, fecha_expiracion, numero_plastico, numero_chip}
    ...
    Partial Public Class cedulasTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [main].[sqlite_default_schema].[cedulas] ([id], [cedula], [nombres], "& _ 
                ...
                "o_chip]) VALUES (@id, @cedula, @nombres, @apellidos, @nacionalidad, @sexo, @luga"& _ 
                "r_nacimiento, @fecha_nacimiento, @profesion, @telefono, @direccion, @fecha_expir"& _ 
                "acion, @numero_plastico, @numero_chip)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [main].[sqlite_default_schema].[cedulas] SET [id] = @id, [cedula] = @cedul"& _ 
                ...
                "ro_plastico, [numero_chip] = @numero_chip WHERE (([id] = @Original_id) AND ((@Is"& _ 
                "Null_cedula = 1 AND [cedula] IS NULL) OR ([cedula] = @Original_cedula)) AND ((@I"& _ 
                ...
                "ellidos)) AND ((@IsNull_nacionalidad = 1 AND [nacionalidad] IS NULL) OR ([nacion"& _ 
                "alidad] = @Original_nacionalidad)) AND ((@IsNull_sexo = 1 AND [sexo] IS NULL) OR"& _ 
                " ([sexo] = @Original_sexo)) AND ((@IsNull_lugar_nacimiento = 1 AND [lugar_nacimi"& _ 
                "ento] IS NULL) OR ([lugar_nacimiento] = @Original_lugar_nacimiento)) AND ((@IsNu"& _ 
                "ll_fecha_nacimiento = 1 AND [fecha_nacimiento] IS NULL) OR ([fecha_nacimiento] ="& _ 
                " @Original_fecha_nacimiento)) AND ((@IsNull_profesion = 1 AND [profesion] IS NUL"& _ 
                "L) OR ([profesion] = @Original_profesion)) AND ((@IsNull_telefono = 1 AND [telef"& _ 
                "ono] IS NULL) OR ([telefono] = @Original_telefono)) AND ((@IsNull_direccion = 1 "& _ 
                "AND [direccion] IS NULL) OR ([direccion] = @Original_direccion)) AND ((@IsNull_f"& _ 
                "echa_expiracion = 1 AND [fecha_expiracion] IS NULL) OR ([fecha_expiracion] = @Or"& _ 
                "iginal_fecha_expiracion)) AND ((@IsNull_numero_plastico = 1 AND [numero_plastico"& _ 
                "] IS NULL) OR ([numero_plastico] = @Original_numero_plastico)) AND ((@IsNull_num"& _ 
                "ero_chip = 1 AND [numero_chip] IS NULL) OR ([numero_chip] = @Original_numero_chi"& _ 
                "p)))"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT [id], [cedula], [nombres], [apellidos], [nacionalidad], [sexo], [lugar_nac"& _ 
                ...
                "acion], [numero_plastico], [numero_chip] FROM [cedulas]"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_id As Long, ByVal Original_cedula As String, ByVal Original_nombres As String, ByVal Original_apellidos As String, ByVal Original_nacionalidad As String, ByVal Original_sexo As String, ByVal Original_lugar_nacimiento As String, ByVal Original_fecha_nacimiento As String, ByVal Original_profesion As String, ByVal Original_telefono As String, ByVal Original_direccion As String, ByVal Original_fecha_expiracion As String, ByVal Original_numero_plastico As String, ByVal Original_numero_chip As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal id As Long, ByVal cedula As String, ByVal nombres As String, ByVal apellidos As String, ByVal nacionalidad As String, ByVal sexo As String, ByVal lugar_nacimiento As String, ByVal fecha_nacimiento As String, ByVal profesion As String, ByVal telefono As String, ByVal direccion As String, ByVal fecha_expiracion As String, ByVal numero_plastico As String, ByVal numero_chip As String) As Integer
        ...
        Public Overloads Overridable Function Update( _
                    ...
                    ByVal Original_numero_chip As String) As Integer
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(22).Value = CType(Original_nacionalidad,String)
            End If
            If (Original_sexo Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(26).Value = CType(Original_lugar_nacimiento,String)
            End If
            If (Original_fecha_nacimiento Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(28).Value = CType(Original_fecha_nacimiento,String)
            End If
            If (Original_profesion Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(30).Value = CType(Original_profesion,String)
            End If
            If (Original_telefono Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(36).Value = CType(Original_fecha_expiracion,String)
            End If
            If (Original_numero_plastico Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(38).Value = CType(Original_numero_plastico,String)
            End If
            If (Original_numero_chip Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(40).Value = CType(Original_numero_chip,String)
            End If
        ...
        Public Overloads Overridable Function Update( _
                    ...
                    ByVal Original_numero_plastico As String,  _
                    ByVal Original_numero_chip As String) As Integer
            Return Me.Update(Original_id, cedula, nombres, apellidos, nacionalidad, sexo, lugar_nacimiento, fecha_nacimiento, profesion, telefono, direccion, fecha_expiracion, numero_plastico, numero_chip, Original_id, Original_cedula, Original_nombres, Original_apellidos, Original_nacionalidad, Original_sexo, Original_lugar_nacimiento, Original_fecha_nacimiento, Original_profesion, Original_telefono, Original_direccion, Original_fecha_expiracion, Original_numero_plastico, Original_numero_chip)
        End Function
    End Class
